...
class DrawCistercian:
    def __init__(self, width, height):
        ...
        self.draw.add_background("#ffffff")
        self.draw.add_line(self.x, self.y1, self.x, self.y2)
    ...
    def draw_1(self, power=0):
        ...
        self.draw.add_line(self.x, y, x2, y)
    ...
    def draw_3(self, power=0):
        ...
        self.draw.add_line(self.x, y1, x2, y2)
